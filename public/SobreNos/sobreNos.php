...
<body>
    ...
    <div id="page">
        <section id="aboutUsDiv" class="row container">
            <div class="col-md-7">
                <div id="aboutUsContent">
                    <h1>Quem é Tá por aqui ?</h1>
                    ...
                    <div id="aboutUsInfo">
                        <p>
                            Além de proporcionar um <strong>sistema eficaz e acessível</strong> para ambos as partes do negócio, Tornamos possível que um serviço esteja mais perto de você e que um trabalhador <strong>autónomo consiga exercer sua profissão ou sua nova habilidade.</strong>
                        </p>
                    </div>  
                </div>
            </div>
