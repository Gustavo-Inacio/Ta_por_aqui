                        ...
                        <div class="card myCard2 mx-3 tinyCard">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    R$ <?= $service_details->orcamento_servico ?> <?= $service_details->crit_orcamento_servico ?>
                                    <br>
                            ...
                            <div class="card-footer">
                                <button class="mybtn mybtn-conversion mybtn-sm my-1"
                                        onclick="acceptRejectService('accept', <?= $service->id_contrato ?>, '<?= $client_name->nome_usuario ?>')">
                                    Aceitar
                                </button>
                                <button class="mybtn mybtn-danger mybtn-sm my-1"
            ...
            <div class="row" id="savedCardsModal">
                ...
                <?php foreach ($asClientRequestedServices as $service) {
                    ...
                    <div class="col-lg-4 col-md-6 mt-3">
                        <div class="card myCard2 mx-3 tinyCard">
                            <div class="card-header myCardHeader2">
                                Você solicitou o serviço de <a href="perfil.php?id=<?= $service->id_prestador ?>"
                                                               class="text-light"><?= $client_name->nome_usuario ?></a>
                            </div>
                            <div class="card-body">
                                <h3 class="card-title"><?= $service_details->nome_servico ?></h3>
                                <p class="card-text">
                        ...
                        <div class="card myCard mx-3 tinyCard">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <strong>Informações básicas:</strong> <br>
                                    <strong>Orçamento:</strong>
                                    R$ <?= $savedService->orcamento_servico ?> <?= $savedService->crit_orcamento_servico ?>
                                    <br>
                            ...
                            <div class="card-footer">
                                <button type="button" class="mybtn mybtn-danger"
                                        onclick="location.href='../../logic/perfil_remover_servicosalvo.php?id=<?= $service->id_servico_salvo ?>'">
                                    Remover
                                </button>
                            </div>
                        </div>
...
<?php } else if ($_GET['servicetype'] === "recentServices") {
    ...
    $query = "SELECT * FROM contratos as c join servicos as s on c.id_servico = s.id_servico WHERE id_cliente = " . $_GET['user'] . " AND c.status_contrato = 1 AND s.status_servico = 1  ORDER BY data_contrato DESC";
    $stmt = $con->query($query);
                    ...
                    <div class="col-lg-4 col-md-6 mt-3">
                        <div class="card myCard3 mx-3 tinyCard">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a href="perfil.php?id=<?= $service->id_prestador ?>"
                                           class="font-weight-bold text-dark"><?= $provider_info->nome_usuario ?></a>
                                        <br>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row" id="requestedServicesCardsModal">
                ...
                <?php foreach ($asProviderAcceptReject as $service) {
                    //nome do cliente que solicitou
                    $query = "SELECT nome_usuario FROM usuarios WHERE id_usuario = $service->id_cliente";
                    $stmt = $con->query($query);
                    $client_name = $stmt->fetch(PDO::FETCH_OBJ);
